		...
		<body>
			<div id = "container">
				...
				<?php
						...
						$sql = "SELECT * FROM fd_class WHERE st_usn = $st_usn ;";
						$res = $db->query($sql);
						if($res->num_rows>0)
						{
...
";
							...
							{
								echo "<tr>";
								echo "<form action='feedview.php' method='POST'>";
								echo "";
								...
								echo '<td><input type="submit" name="submit" VALUE="View_Report" class="buttonup"></td>';
					...
					<?php
						...
						{
							echo "<h2>FEEDBACK FORMS NOT ENABLED FOR NOW TO $st_usn</H2>";
						}
