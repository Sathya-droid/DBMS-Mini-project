...
";
							...
							{
								echo "<tr>";
								echo "<form action='marksupdate.php' method='POST'>";
								...
								echo '<td><input type="submit" name="add" VALUE="add" class="buttonup"></td>';
								echo '<td><input type="submit" name="update" VALUE="UPDATE" class="buttonup"></td>';
